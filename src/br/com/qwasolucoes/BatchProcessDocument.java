...
public class BatchProcessDocument {
	...
	public static void batchProcessDocument()
		...
		String outputGcsBucketName = "poc-document-ai";
		String outputGcsPrefix = "poc-bacth";
		String inputGcsUri = "gs://poc-document-ai/CNH.pdf";
		batchProcessDocument(projectId, location, processerId, inputGcsUri, outputGcsBucketName, outputGcsPrefix);
	}

	public static void batchProcessDocument(String projectId, String location, String processorId, String gcsInputUri,
			String gcsOutputBucketName, String gcsOutputUriPrefix)
			throws IOException, InterruptedException, TimeoutException, ExecutionException {
		...
		try (DocumentProcessorServiceClient client = DocumentProcessorServiceClient.create()) {
			...
			GcsDocument gcsDocument = GcsDocument.newBuilder().setGcsUri(gcsInputUri).setMimeType("application/pdf")
					.build();
			...
			BatchProcessRequest request = BatchProcessRequest.newBuilder().setName(name).setInputDocuments(inputConfig)
					.setDocumentOutputConfig(documentOutputConfig).build();
